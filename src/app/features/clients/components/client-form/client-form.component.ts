...
import { ChangeDetectionStrategy, Component, EventEmitter, inject, OnInit, output, Output, OutputEmitterRef } from '@angular/core';
import {
  FormBuilder,
  FormGroup,
  FormsModule,
...
export class ClientFormComponent implements OnInit {
  ...
  submitEmit : OutputEmitterRef<Client> = output<Client>();
